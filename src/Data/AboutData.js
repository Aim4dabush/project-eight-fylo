export const AboutData = [
  {
    image: process.env.PUBLIC_URL + "/images/about/icon-access-anywhere.svg",
  ...
  {
    image: process.env.PUBLIC_URL + "/images/about/icon-security.svg",
  ...
  {
    image: process.env.PUBLIC_URL + "/images/about/icon-collaboration.svg",
  ...
  {
    image: process.env.PUBLIC_URL + "/images/about/icon-any-file.svg",
